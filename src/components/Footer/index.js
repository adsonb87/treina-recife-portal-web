...
function Footer(){
    return (
        ...
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            ...
            <li className="ms-3"><a class="text-body-secondary" href="/">< AiFillInstagram size={30} color="blue" /></a></li>
            <li className="ms-3"><a class="text-body-secondary" href="/"><AiFillFacebook size={30} color="blue"/></a></li>
            </ul>
        </footer>
        </div>
    )
